...
describe('Usuarios', function () {  
  it('Codigo de estado debe ser 200 y sin errores', function () {
    expect(this.err).to.equal(null);
    //compruebo si hay error
    expect(this.res.statusCode).to.equal(200);
    //compruebo codigo de estado
  })
  it('debe exitir ga@pis.com"', function () {
    expect(this.body).to.include('"email": "ga@pis.com"');
  })
  it('debe exitir mi@pis.com"', function () {
    expect(this.body).to.include('"email": "mi@pis.com"');
  })
  it('debe exitir bg@pis.com"', function () {
    expect(this.body).to.include('"email": "bg@pis.com"');
  })
  it('No debe exitir sebas@pis.com"', function () {
